...
def create_placeholders(n_H0, n_W0, n_C0, n_y):
    ...
    Creates the placeholders for the tensorflow session - height, width, number of channels and number of output classes
...
def initialize_parameters():
    ...
    # Initializes weight parameters to build a neural network with tensorflow. The shapes for my images (which are hard coded) are:
                        W1 : [4, 4, 3, 8]
                        W2 : [2, 2, 8, 16]
